...
public class TimeSpanTest {
    ...
    @Test
    public void testIsOverlappin_Non_overlapping_timespans_return_false() {
    ...
    @Test
    public void testIsOverlappin_Overlapping_timespans_return_true() {
        Calendar calendar1 = Calendar.getInstance();         
        calendar1.set(2013, 01, 16,10,00,00);
    ...
    @Test
    public void testIsOverlappin_Adjecent_begin_and_end_return_false() {
        Calendar calendar1 = Calendar.getInstance();         
    ...
    @Test
    public void testIsOverlappin_Adjecent_end_and_begin_return_false() {
        Calendar calendar1 = Calendar.getInstance();         
        calendar1.set(2013, 01, 16,10,0,0);
    ...
    @Test
    public void testIsOverlappin_otherTimeSpan_contained_in_current_returns_true() {
        Calendar calendar1 = Calendar.getInstance();         
        calendar1.set(2013, 01, 16,10,0,0);
