...
{   
    ...
    {
        StringBuilder inhoud = new StringBuilder();
        inhoud.append("Student ").append(gebruiker.getVoornaam()).append(" ").append(gebruiker.getAchternaam());
     ...
     * @return True indien de mail verzonden is, 
     * false indien die niet verzonden werd.
     */
    @Override
    public boolean sendAntwoordFAQMail(FAQ faq, Gebruiker buddy)
    {
        ...
        inhoud.append(buddy.getVoornaam()).append(" ").append(buddy.getAchternaam()).append("<br>");
    ...
    public boolean sentNieuweFAQMail(FAQ faq)
    {
        ...
        inhoud.append("Gebruiker <b>").append(faq.getGebruiker().getVoornaam()).append(" ").append(faq.getGebruiker().getAchternaam()).append("</b> heeft een nieuwe vraag gesteld.<br>");
    ...
    public boolean sendNieuweAanvraagMailNaarBuddy(Aanvraag aanvraag, Gebruiker buddy)
    {
        ...
        inhoud.append("Beginuur: ").append(aanvraag.getBeginTijdstip()).append(" uur.<br>");
    ...
    {
        StringBuilder inhoud = new StringBuilder();
        inhoud.append("Gebruiker ").append(support.getZender().getVoornaam()).append(" ").append(support.getZender().getAchternaam());
    ...
    public boolean sendMailVoorGoedkeuring(String email, Aanvraag aanvraag)
    {
        ...
        inhoud.append("Student <b>").append(aanvraag.getAanvrager().getVoornaam()).append(" ").append(aanvraag.getAanvrager().getAchternaam()).append("</b>");
    ...
    public boolean sendNieuweAanvraagIngediend(Aanvraag aanvraag)
    {
        ...
        inhoud.append("Datum: ").append(aanvraag.getAanvraagDatum().getTime()).append("<br>");
        inhoud.append("Beginuur: ").append(aanvraag.getBeginTijdstip()).append(" uur.<br>");
        inhoud.append("Einduur: ").append(aanvraag.getEindTijdstip()).append(" uur.<br>");
        inhoud.append("Lokaal: ").append(aanvraag.getLokaal()).append("<br>");
        ...
        inhoud2.append("Beginuur: ").append(aanvraag.getBeginTijdstip()).append(" uur.<br>");
        inhoud2.append("Einduur: ").append(aanvraag.getEindTijdstip()).append(" uur.<br>");
